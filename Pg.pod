...
=for memo いきなりエラーじゃないのか？この最後の2行
...
=for memo 原文の C<lo_write> は明らかに C<lo_open> の間違い。
...
=for memo tread carefully は treat carefully か？
...
=for memo 原文の Please not は Please note の typo
...
しか持てないという制限を
PostgreSQL は blob をテーブルとは別に、いわゆる object-id を使って扱います。
